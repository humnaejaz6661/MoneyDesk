...
class ResetupScreenComponents {
  static Widget OtpTextWidget(
    ...
    return Obx(() {
      resetscreenController.refreshUI.value;
      bool isFilled = resetscreenController.controllerr[index].text.isNotEmpty;

      return SizedBox(
        height: 30,
        width: 30,
        child: TextFormField(
          controller: resetscreenController.controllerr[index],
          readOnly: true,
          showCursor: false,
          maxLength: 1,
